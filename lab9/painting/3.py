...
def main():
    ...
    directory = ""
    #my files
    pen = pygame.image.load(directory + "pen.jpg")
    rubber = pygame.image.load(directory + "rubber.jpg")

    up = pygame.image.load(directory + "up.jpg")
    down = pygame.image.load(directory + "down.jpg")

    save = pygame.image.load(directory + "save.jpg")
    screen.fill(WHITE)
    mode = BLACK
    # mode = 'random'
    draw_on = False
